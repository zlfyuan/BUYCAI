...
-(void)setUI
{
    ...
    TWHTextFiled *nameLab = [[TWHTextFiled alloc]initWithFrame:CGRectMake(0, idTf.frame.origin.y+idTf.frame.size.height-1, self.view.frame.size.width, 40) placehold:@"" labtext:@"  姓    名:" tfTextColor:[UIColor blackColor] tfText:@"  游客"];
    ...
    TWHTextFiled *detailAddressTf = [[TWHTextFiled alloc]initWithFrame:CGRectMake(0, buyerCityTf.frame.origin.y+buyerCityTf.frame.size.height-1, self.view.frame.size.width, 40) placehold:@"未填写详细地址(如xx区xx路)" labtext:@"  详细地址:" tfTextColor:[UIColor blackColor] tfText:@""];
